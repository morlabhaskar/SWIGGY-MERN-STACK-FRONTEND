  ...
  return (
    <section class="body-font py-1 w-[90%] mx-auto">
      ...
      <div className='flex items-center mb-5 justify-center'>
        <span className='ml-4 flex justify-center'><CiFilter className='text-blue-500 text-2xl' /></span>
        <div className='filter-btns flex items-center justify-start gap-2 py-4'>
